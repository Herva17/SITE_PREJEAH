...
<body>
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="container carousel-content">
                            ...
                            <h1 class="text-white display-1 mb-4 animated fadeInRight">Une agence de solutions
                                informatiques innovantes</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container carousel-content">
                            <h6 class="text-secondary h4 animated fadeInUp">Meilleures solutions informatiques</h6>
                            <h1 class="text-white display-1 mb-4 animated fadeInLeft">Services de qualité dont vous avez
                                vraiment besoin !</h1>
                            <p class="mb-4 text-white fs-5 animated fadeInDown">Lorem ipsum dolor sit amet elit. Sed
                                efficitur quis purus ut interdum. Pellentesque aliquam dolor eget urna ultricies
                                tincidunt.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 wow fadeIn" data-wow-delay=".3s">
                    <div class="d-flex counter">
                        ...
                        <h5 class="text-white mt-1">partenaires</h5>
                    </div>
                </div>
                <div class="col-lg-3 wow fadeIn" data-wow-delay=".5s">
                    <div class="d-flex counter">
                        <h1 class="me-3 text-primary counter-value">120</h1>
                        <h5 class="text-white mt-1">Total Clients</h5>
                    </div>
                </div>
                <div class="col-lg-3 wow fadeIn" data-wow-delay=".7s">
                    <div class="d-flex counter">
                        <h1 class="me-3 text-primary counter-value">5</h1>
                        <h5 class="text-white mt-1">Avis des clients</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-5">
            <div class="row g-5">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                    <h5 class="text-primary">Apropos de nous</h5>
                    <h1 class="mb-4">À propos de la societe PREJEAH Tech et de ses solutions informatiques</h1>
                    <p> Nous sommes une société expérimentée dans ce domaine et nous avons déjà aidé de nombreuses
                        entreprises à se dévellopper. Si vous êtes intéressé par nos services, n'hésitez pas à nous
                        contacter pour en savoir plus. Nous serons ravis de répondre à toutes vos questions et de vous
                        aider à trouver une solution adaptée à vos besoins.
                        Je vous remercie pour votre attention et j'espère avoir bientôt de vos nouvelles.
                        Cordialement</p>
                    <p class="mb-4">Notre entreprise a déjà collaboré avec de nombreuses autres entreprises et nous
                        sommes convaincus que notre savoir-faire et notre flexibilité sauront répondre à vos attentes.
                        Si vous êtes intéressé par notre offre, n'hésitez pas à nous contacter pour en savoir en détail.
                    </p>
                    <a href="" class="btn btn-secondary rounded-pill px-5 py-3 text-white">En savoir plus</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="services-item bg-light">
                        <div class="p-4 text-center services-content">
                            <div class="services-content-icon">
                                ...
                                <h4 class="mb-3">Designer web</h4>
                                <p class="mb-4">Nos experts webdesigner œuvrent à la conception d’interfaces de sites &
                                    applications mobiles efficaces, adaptées à tous les devices</p>
                                <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">En savoir
                                    plus</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="services-item bg-light">
                        <div class="p-4 text-center services-content">
                            <div class="services-content-icon">
                                ...
                                <h4 class="mb-3">develloppement web</h4>
                                <p class="mb-4">Nos experts develloppeurs webs oeuvres pour la conception des vos sites
                                    web et applications web envie du develloppement </p>
                                <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">En savoir
                                    plus</a>
                            </div>
                        </div>
                    ...
                    <div class="services-item bg-light">
                        <div class="p-4 text-center services-content">
                            <div class="services-content-icon">
                                ...
                                <h4 class="mb-3"> Designer UI/UX</h4>
                                <p class="mb-4">Nos experts UX designer, UI designer et webdesigner œuvrent à la
                                    conception d’interfaces de sites & applications mobiles efficaces</p>
                                <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">En savoir
                                    plus</a>
                            </div>
                        </div>
                    ...
                    <div class="services-item bg-light">
                        <div class="p-4 text-center services-content">
                            <div class="services-content-icon">
                                ...
                                <h4 class="mb-3">Sécurite web</h4>
                                <p class="mb-4">Nos Experts mettent en place des systemes capable à assurer la sécurite
                                    de vos logiciels contre les anarquages</p>
                                <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">En savoir
                                    plus</a>
                            </div>
                    ...
                    <div class="services-item bg-light">
                        <div class="p-4 text-center services-content">
                            <div class="services-content-icon">
                                ...
                                <p class="mb-4">Nous Mettons à votre disposition le service de la margetique digital
                                    envie d'augmenter les visites sur votre site web</p>
                                <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">En savoir
                                    plus</a>
                            </div>
                        </div>
                    ...
                    <div class="services-item bg-light">
                        <div class="p-4 text-center services-content">
                            <div class="services-content-icon">
                                ...
                                <p class="mb-4">Nous produisons des blocs d'instructions des codes capable de produire
                                    des sites web et des applications web</p>
                                <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">En savoir
                                    plus</a>
                            </div>
                        </div>
    ...
    <div class="container-fluid project py-5 mb-5">
        <div class="container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                ...
                <h1>
                    Nos projets récemment terminés</h1>
            </div>
            <div class="row g-5">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".3s">
                        ...
                        <div class="project-img">
                            ...
                            <div class="project-content">
                                <a href="#" class="text-center">
                                    <h4 class="text-secondary">Designer Web</h4>
                                    <p class="m-0 text-white">Analystes Web</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".5s">
                    <div class="project-item">
                        <div class="project-img">
                            ...
                            <div class="project-content">
                                <a href="#" class="text-center">
                                    <h4 class="text-secondary">La cyber-sécurité</h4>
                                    <p class="m-0 text-white">
                                        Noyau de cybersécurité</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".3s">
                    <div class="project-item">
                        <div class="project-img">
                            ...
                            <div class="project-content">
                                <a href="#" class="text-center">
                                    <h4 class="text-secondary"> Developpement Web</h4>
                                    <p class="m-0 text-white">Analystes Web</p>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".5s">
                    <div class="project-item">
                        <div class="project-img">
                            ...
                            <div class="project-content">
                                <a href="#" class="text-center">
                                    <h4 class="text-secondary"> Marketing Digital</h4>
                                    <p class="m-0 text-white">
                                        Analyse marketing</p>
                                </a>
                            </div>
                            ...
                            <div class="project-content">
                                <a href="#" class="text-center">
                                    <h4 class="text-secondary">
                                        Recherche de mots-clés</h4>
                                    <p class="m-0 text-white">
                                        Analyse des mots clés</p>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid blog py-5 mb-5">
        <div class="container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                ...
                <h1>
                    Derniers blogs et actualités</h1>
            </div>
            <div class="row g-5 justify-content-center">
                <div class="col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".3s">
                    <div class="blog-item position-relative bg-light rounded">
                        ...
                        <span class="position-absolute px-4 py-3 bg-primary text-white rounded"
                            style="top: -28px; right: 20px;">Designer Web</span>
                        <div class="blog-btn d-flex justify-content-between position-relative px-3"
                            style="margin-top: -75px;">
                            <div class="blog-icon btn btn-secondary px-3 rounded-pill my-auto">
                                <a href="Authentification.php" class="btn text-white">Commenter</a>
                            </div>
                        ...
                        <div class="blog-content text-center position-relative px-3" style="margin-top: -25px;">
                            <img src="img/admin.jpg" class="img-fluid rounded-circle border border-4 border-white mb-3"
                                alt="">
                            <h5 class="">By Jeannette UMUTONI</h5>
                            <span class="text-secondary">24 Mars 2023</span>
                            <p class="py-2">La sociéte PREJEAH Tech Réconnue comme la meilleur societe de dévelloppement des sites et applications web et mobile sur l'étendue de la RDC
                                </p>
                        </div>
                        <div
                            class="blog-coment d-flex justify-content-between px-4 py-2 border bg-primary rounded-bottom">
                            <a href="" class="text-white"><small><i class="fas fa-share me-2 text-secondary"></i>109343
                                    partages</small></a>
                            <a href="" class="text-white"><small><i class="fa fa-comments me-2 text-secondary"></i>5
                                    Commentaires</small></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".5s">
                    <div class="blog-item position-relative bg-light rounded">
                        ...
                        <span class="position-absolute px-4 py-3 bg-primary text-white rounded"
                            style="top: -28px; right: 20px;">Developpement</span>
                        <div class="blog-btn d-flex justify-content-between position-relative px-3"
                            style="margin-top: -75px;">
                            <div class="blog-icon btn btn-secondary px-3 rounded-pill my-auto">
                                <a href="Authentification.php" class="btn text-white ">Commenter</a>
                        ...
                        <div class="blog-content text-center position-relative px-3" style="margin-top: -25px;">
                            <img src="img/admin.jpg" class="img-fluid rounded-circle border border-4 border-white mb-3"
                                alt="">
                            <h5 class="">By Précieuse BIBENTYO</h5>
                            <span class="text-secondary">26 Avril 2023</span>
                            <p class="py-2"> c'est parmi les actualites exceptionnelles,la sociéte PREJEAH Tech a augmentée sa clientelle non seulement sur l'étendue de la RDC mais en afrique entiere</p>
                        </div>
                        <div
                            class="blog-coment d-flex justify-content-between px-4 py-2 border bg-primary rounded-bottom">
                            <a href="" class="text-white"><small><i class="fas fa-share me-2 text-secondary"></i>545690
                                    Partages</small></a>
                            <a href="" class="text-white"><small><i class="fa fa-comments me-2 text-secondary"></i>10
                                    Commentaires</small></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".7s">
                    <div class="blog-item position-relative bg-light rounded">
                        ...
                        <span class="position-absolute px-4 py-3 bg-primary text-white rounded"
                            style="top: -28px; right: 20px;">App Mobile</span>
                        <div class="blog-btn d-flex justify-content-between position-relative px-3"
                            style="margin-top: -75px;">
                            <div class="blog-icon btn btn-secondary px-3 rounded-pill my-auto">
                                <a href="Authentification.php" class="btn text-white ">Commenter</a>
                        ...
                        <div class="blog-content text-center position-relative px-3" style="margin-top: -25px;">
                            <img src="img/admin.jpg" class="img-fluid rounded-circle border border-4 border-white mb-3"
                                alt="">
                            <h5 class="">By Hervé IRAGI</h5>
                            <span class="text-secondary">30 jan 2023</span>
                            <p class="py-2">La loyaute et la rentabilite de la societe PREJEAH Tech l'a pemis de gagner plus des clientelles dans l'etendues de la RDC , en Afrique et une partie de l'europe</p>
                        </div>
                        <div
                            class="blog-coments d-flex justify-content-between px-4 py-2 border bg-primary rounded-bottom">
                            <a href="" class="text-white"><small><i class="fas fa-share me-2 text-secondary"></i>532345
                                    partages</small></a>
                            <a href="" class="text-white"><small><i class="fa fa-comments me-2 text-secondary"></i>23
                                    Commentaires</small></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5 mb-5 team">
        <div class="container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                ...
                <h1>
                    Rencontrez notre équipe d'experts</h1>
            </div>
                    ...
                    <div class="team-content">
                        <div class="team-img-icon">
                            ...
                            <div class="team-name text-center py-3">
                                <h4 class="">Hervé IRAGI</h4>
                                <p class="m-0">Ir Systéme</p>
                            </div>
                ...
                <div class="rounded team-item">
                    <div class="team-content">
                        <div class="team-img-icon">
                            ...
                            <div class="team-name text-center py-3">
                                <h4 class="">Précieuse BIBENTYO</h4>
                                <p class="m-0">Ir Systéme</p>
                            </div>
                            <div class="team-icon d-flex justify-content-center pb-4">
                                <a class="btn btn-square btn-secondary text-white rounded-circle m-1" href=""><i
    ...
    <div class="container-fluid testimonial py-5 mb-5">
        <div class="container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                <h5 class="text-primary">Temoignage</h5>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay=".5s">
                <div class="testimonial-item border p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-4">
                            <h4 class="text-secondary">Franck Nestor</h4>
                            <p class="m-0 pb-3">Dev web</p>
                    ...
                    <div class="border-top mt-4 pt-3">
                        <p class="mb-0">Je suis convaincu et impressionne par la sociéte PREJEAH Tech, Sa façon de réalise et concevoir les applications 
                            et la capacite qu' a le team , je ne suis pas membres du team mais d'apres ce que j'observe elle a la meilleure de societe que je n'ai jamais vue
                        </p>
                    </div>
                </div>
                <div class="testimonial-item border p-4">
                    <div class=" d-flex align-items-center">
                        ...
                        <div class="ms-4">
                            <h4 class="text-secondary">Delphin selemani</h4>
                            <p class="m-0 pb-3">Designer web</p>
                            <div class="d-flex pe-5">
                                <i class="fas fa-star me-1 text-primary"></i>
                                <i class="fas fa-star me-1 text-primary"></i>
                                <i class="fas fa-star me-1 text-primary"></i>
                ...
                <div class="testimonial-item border p-4">
                    <div class=" d-flex align-items-center">
                        ...
                        <div class="ms-4">
                            <h4 class="text-secondary">Lievin KASEREKA</h4>
    ...
    <div class="container-fluid py-5 mb-5">
        <div class="container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                ...
                <h1 class="mb-3">
                    Contact pour toute question</h1>
            </div>
                ...
                <div class="row g-5 mb-5 justify-content-center">
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                ...
                                <a href="https://goo.gl/maps/Zd4BCynmTb98ivUJ6" target="_blank" class="h5">25 Kyeshero, Goma</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                <h4 class="text-primary">
                                    Appelez-nous</h4>
                                <a class="h5" href="" target="_blank">+243 977404036</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                <h4 class="text-primary">pour le mail</h4>
                                <a class="h5" href="mailto:prejeahtech@gmail.com" target="_blank">prejeahtech@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                        <div class="p-5 rounded contact-form">
                            ...
                            <div class="mb-4">
                                <input type="email" class="form-control border-0 py-3" placeholder="Votre mail">
                            </div>
                            <div class="mb-4">
